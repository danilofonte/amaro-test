...
(
   HJMPTS bigint,
   CREATEDTS timestamp DEFAULT NOT NULL,
   MODIFIEDTS timestamp DEFAULT NOT NULL,
   TYPEPKSTRING bigint,
   ...
   P_ONLINEDATE timestamp DEFAULT NOT NULL,
   P_OFFLINEDATE timestamp DEFAULT NOT NULL,
   P_EAN varchar(255),
   ...
   P_VENUE varchar(255),
   P_DATE timestamp DEFAULT NOT NULL,
